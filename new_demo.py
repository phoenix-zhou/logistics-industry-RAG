...
from langchain.vectorstores import FAISS # 向量库
from langchain.llms import QianfanLLMEndpoint # 千帆大模型平台库
import streamlit as st # 搭建web界面
from langchain.chains import ConversationalRetrievalChain # 对话检索链
from config import * # config文件配置API_key等参数
import os
...
# 设置web页面：比如标题、描述功能
st.title("《农学院--物流行业信息咨询》")
st.write("请上传一个关于物流信息的pdf文档.")
# 设置上传pdf文件的功能
...
# 从pdf中提取文档
    ...
    print(raw_text)
    print('*'*80)
    text_splitter = CharacterTextSplitter(separator=' ', chunk_size=10, chunk_overlap=1)
    ...
    # print(embeddings.embed_query("你好吗"))
    # 创建文档搜索
